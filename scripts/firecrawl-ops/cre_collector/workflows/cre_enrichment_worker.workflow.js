...
- WORKER (cre_enrich.py) = pure builders + thin run(): build_claim_sql (no attempts++ at claim; FOR UPDATE SKIP LOCKED;
  ...
  (URL match, id-keyed completion), build_complete_sql (DELETE done rows by claimed id; queue is ephemeral, cre_listing_events is the audit), build_release_sql
