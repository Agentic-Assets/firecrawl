...
bash tests/run_listing_lifecycle_postgres_contract.sh  # opt-in local PostgreSQL 15+ contract
```
...
server is older than PostgreSQL 15. It never accepts a database URL.
