...
- `.claude/skills/firecrawl-ops/SKILL.md` — entry point. Defines default model routing (budget: `openrouter/minimax/minimax-m2.5`, escalated: `moonshotai/kimi-k2.5`), the standard "verify health → pick endpoint → apply model profile" workflow, and links to all references and scripts.
